...
const postCreateFeedByReqUserBtn = async (channelId, selectedFeedImages) => {
    ...
    try {
        ...
        const resData = await fetch(`/client/channel/create-feed/${channelId}`, {
            method: 'POST',
            body: formData
        })
...
const patchEditFeedByReqUserBtn = async (channelId, selectedFeedImages, e) => {
    ...
    try {
        ...
        const resData = await fetch(`/client/channel/edit-feed/${channelId}/${feedId}`, {
            method: 'PATCH',
            body: formData
        })
...
const deleteRemoveFeedByReqUser = async e => {
    const feedId = e.target.dataset.feedid;
    try {
        const data = await fetch(`/client/channel/delete-feed/${this.channelId}/${feedId}`, {
            method: 'DELETE',
            headers: {
...
const patchPlusOrMinusNumberOfLikeInFeed = async (channelId, feedId, e) => {
    try {
        const response = await fetch(`/client/channel/plus-or-minus-feed-like`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json'
            },
...
const patchEditChannelByReqUser = async () => {
    ...
    try {
        ...
        const resData = await fetch(`/client/channel/edit-channel/${this.channelId}`, {
            method: 'PATCH',
            body: formData
        })
        ...
        window.location = `/mychannel/${this.channelId}?searchType=info`
    } catch (error) {
        console.log(error);
    }
}
